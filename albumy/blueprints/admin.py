from flask import Blueprint, render_template, flash, Blueprint, request, current_app
...
def index():
    ...
    return render_template(
        "admin/index.html", user_count=user_count, photo_count=photo_count,
        tag_count=tag_count, comment_count=comment_count, locked_user_count=locked_user_count,
        blocked_user_count=blocked_user_count, reported_comments_count=reported_comments_count, reported_photo_count=reported_photo_count)
