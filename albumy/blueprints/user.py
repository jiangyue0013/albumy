...
from albumy.forms.user import (
    EditProfileForm, UploadAvatarForm, CropAvatarForm, 
    ChangeEmailForm, ChangePasswordForm, NotificationSettingForm,
    PrivacySettingForm, DeleteAccountForm
)
from albumy.settings import Operations
from albumy.utils import (
    generate_token, validate_token, redirect_back, 
    flash_errors
)
...
@user_bp.route("/settings/change-mail", methods=["GET", "POST"])
@fresh_login_required
...
@user_bp.route("/change-eamil/<token>")
@login_required
...
@user_bp.route("/setting/notifications", methods=["GET", "POST"])
@login_required
...
@user_bp.route("/setting/privacy", methods=["GET", "POST"])
@login_required
def privacy_setting():
